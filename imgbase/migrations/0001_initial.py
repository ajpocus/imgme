...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('imgbase_profile', (
            ...
            ('imgur_id', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('imgbase', ['Profile'])


    def backwards(self, orm):
        # Deleting model 'Profile'
        db.delete_table('imgbase_profile')
    ...
    models = {
        ...
        'imgbase.profile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'imgur_id': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'refresh_token': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        }
    }

    complete_apps = ['imgbase']